  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-4">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-900">Hospitals</a>
            <a href="#" className="text-gray-600 hover:text-gray-900">Labs and Diagnostics</a>
            <a href="#" className="text-gray-600 hover:text-gray-900">Surgeries</a>
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="bg-gradient-to-r from-purple-700 to-indigo-800 rounded-lg p-8 mb-8 text-white">
          <h1 className="text-4xl font-bold mb-4">Find and Book the Best Doctors near you</h1>
          <div className="flex bg-white rounded-lg overflow-hidden">
            <div className="flex-1 flex items-center px-4">
              <MapPin className="text-gray-400 mr-2" />
              <Input type="text" placeholder="Enter city" className="border-0 focus:ring-0" />
            </div>
            <div className="flex-1 flex items-center px-4 border-l border-gray-200">
              <Search className="text-gray-400 mr-2" />
              <Input type="text" placeholder="Search doctors, hospitals, conditions" className="border-0 focus:ring-0" />
            </div>
            <Button className="rounded-none px-8">Search</Button>
          </div>
        </section>
